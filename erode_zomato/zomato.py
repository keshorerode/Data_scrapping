...
with open(os.path.join(BASE_DIR, "erode_hotels.txt"), "r", encoding="utf-8") as f:
...
for i, url in enumerate(urls, 1):
    ...
    try:
        ...
        with open(os.path.join(BASE_DIR, "zomato_multi.json"), "w", encoding="utf-8") as f:
...
print("Saved to: zomato_multi.json")
print("========================================")
